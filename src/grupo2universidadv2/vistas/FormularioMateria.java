...
public class FormularioMateria extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 150, -1, -1));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            if (materiaActual != null) {
                ...
                jtEstado.setSelected(materiaActual.isActivo());
                jbGuardarMateria.setEnabled(true);
                JOptionPane.showMessageDialog(this, "Modifique los campos y presione Guardar");
            } else {
                JOptionPane.showMessageDialog(this, "No se encontró la materia con ese código");
            }
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "Ingrese un número válido para el código");
        }
