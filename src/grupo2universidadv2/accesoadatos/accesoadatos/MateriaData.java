...
package grupo2universidadv2.accesoadatos.accesoadatos;
...
public class MateriaData {
   ...
   public void estadoMateria(int idMateria) {
        ...
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "No se pudo dar de baja la materia", "Error", JOptionPane.ERROR_MESSAGE);
...
public List<Materia> listarMaterias() {
    ...
    String query = "SELECT * FROM materia WHERE estado = 1"; // solo activas
    ...
    try {
        ...
        e.printStackTrace();
        JOptionPane.showMessageDialog(null, "No se pudo mostrar la lista de materias", "Error", JOptionPane.ERROR_MESSAGE);
    }
